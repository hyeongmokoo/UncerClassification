...
{
    public partial class frmOptClassfication : Form
    {
        ...
        private void cboSourceLayer_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                int intLIndex = GetIndexNumberFromLayerName(m_pActiveView, cboSourceLayer.Text);
                ILayer pLayer = m_pActiveView.FocusMap.get_Layer(intLIndex);
        ...
        private void btnApply_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                pColorOutline = getRGB(picGCLineColor.BackColor.R, picGCLineColor.BackColor.G, picGCLineColor.BackColor.B);
                ...
                for (int j = 0; j < m_intGCBreakeCount; j++)
                {
                    ...
                    IRgbColor pRGBColor = getRGB(m_arrColors[j, 0], m_arrColors[j, 1], m_arrColors[j, 2]);
                    if (pRGBColor == null)
                        return;
        ...
        public frmOptClassfication()
        {
            try
            {
                ...
                m_pActiveView = ArcMap.Document.ActiveView;

                //m_pSnippet = new clsSnippet();
                //m_pBL = new clsBrusingLinking();

                for (int i = 0; i < m_pActiveView.FocusMap.LayerCount; i++)
                {
                    IFeatureLayer pFeatureLayer = (IFeatureLayer)m_pActiveView.FocusMap.get_Layer(i);

                    if (pFeatureLayer.FeatureClass.ShapeType == esriGeometryType.esriGeometryPolygon)
                        cboSourceLayer.Items.Add(m_pActiveView.FocusMap.get_Layer(i).Name);
                }
        ...
        private IEnumColors MultiPartColorRamp(string strColorRamp, string strAlgorithm, int intGCBreakeCount)
        {
            try
            {
                ...
                if (strColorRamp == "Blue Light to Dark" || strColorRamp == "Green Light to Dark" || strColorRamp == "Orange Light to Dark" || strColorRamp == "Red Light to Dark")
                {
                    ...
                    switch (strColorRamp)
                    {
                        case "Blue Light to Dark":
                            pColor1 = getRGB(239, 243, 255);
                            pColor2 = getRGB(8, 81, 156);
                            break;
                        case "Green Light to Dark":
                            pColor1 = getRGB(237, 248, 233);
                            pColor2 = getRGB(0, 109, 44);
                            break;
                        case "Orange Light to Dark":
                            pColor1 = getRGB(254, 237, 222);
                            pColor2 = getRGB(166, 54, 3);
                            break;
                        case "Red Light to Dark":
                            pColor1 = getRGB(254, 229, 217);
                            pColor2 = getRGB(165, 15, 21);
                            break;
                        default:
                            pColor1 = getRGB(254, 229, 217);
                            pColor2 = getRGB(165, 15, 21);
                ...
                else
                {
                    ...
                    {
                        case "Blue to Red":
                            pColor1 = getRGB(49, 54, 149);
                            pColor2 = getRGB(255, 255, 191);
                            pColor3 = getRGB(165, 0, 38);
                            break;
                        case "Green to Purple":
                            pColor1 = getRGB(0, 68, 27);
                            pColor2 = getRGB(247, 247, 247);
                            pColor3 = getRGB(64, 0, 75);
                            break;
                        case "Green to Red":
                            pColor1 = getRGB(0, 104, 55);
                            pColor2 = getRGB(255, 255, 191);
                            pColor3 = getRGB(165, 0, 38);
                            break;
                        case "Purple to Brown":
                            pColor1 = getRGB(45, 0, 75);
                            pColor2 = getRGB(247, 247, 247);
                            pColor3 = getRGB(127, 59, 8);
                            break;
                        default:
                            pColor1 = getRGB(49, 54, 149);
                            pColor2 = getRGB(255, 255, 191);
        ...
        private void AddUncertaintyRangeLineSeries(frmOptClassfication pOptSample, string strSeriesName, System.Drawing.Color FillColor, double dblY, double dblXMin, double dblXMax)
        {
            try
            {
        ...
        private void AddVerEdgeLineSeries(frmOptClassfication pOptSample, string strSeriesName, System.Drawing.Color FillColor, double dblY, double dblX, double dblScaleY)
        {
            try
            {
                var pSeries = new System.Windows.Forms.DataVisualization.Charting.Series
        ...
        private void AddVerticalLineSeries2(frmOptClassfication pfrmOptSamp, string strSeriesName, System.Drawing.Color FillColor, double dblX, double dblYMin, double dblYMax)
        {
            try
            {
                var pSeries = new System.Windows.Forms.DataVisualization.Charting.Series
        ...
        private void AddAreaChartSeries(frmOptClassfication pfrmOptSamp, string strSeriesName, System.Drawing.Color FillColor, double dblMinX, double dblMaxX, double dblY)
        {
            try
            {
                var pSeries = new System.Windows.Forms.DataVisualization.Charting.Series
